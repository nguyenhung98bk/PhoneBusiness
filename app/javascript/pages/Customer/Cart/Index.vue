    ...
    <div class="cart-content">
      <div class="cart-content-container">
        <div v-for="(cart, index) in carts" :key="index" class="cart-item">
          <div class="cart-item-radio"><input type="radio"></div>
          ...
          <div class="cart-item-quantity">
            <button class="button-change-quantity left"><b-icon-dash variant="danger" scale="1.5" @click="changeQuantity(index, cart.quantity - 1)" /></button>
            <div class="display-item-quantity">{{ cart.quantity }}</div>
            <button class="button-change-quantity right"><b-icon-plus variant="danger" scale="1.5" @click="changeQuantity(index, cart.quantity + 1)" /></button>
          </div>
        </div>
      </div>
    </div>
